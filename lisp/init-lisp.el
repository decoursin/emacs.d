;; Copied from Purcell
;; Nick DeCoursin made significat changes to this file.
...
;; Nick check this.
;; Just adds pprint ability to some functions.
...
;; not loading for some reason -nick
...
;;(require-package 'redshank) ;; Removed by Nick
;(maybe-require-package 'aggressive-indent) ;; Removed by Nick

(defun sanityinc/lisp-setup ()
  "Enable features useful in any Lisp mode."
  (rainbow-delimiters-mode t)
  ;(enable-paredit-mode) ;; Commented out by Nick
  (turn-on-eldoc-mode)
...
;; To end read only buffer: C-x C-q



;; A quick way to jump to the definition of a function given its key binding
;; Nick, this is kinda cool I guess
...

;; Nick, move this? I think jcf is doing cooler things here.
